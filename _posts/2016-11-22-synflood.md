---
layout:     post
title:      "Synflood (OSX, Linux)"
date:       2016-11-22 20:19:00
summary:    "A simple, fast synflood program"
categories: things stuff
---

Whether you're stress-testing your networking application or taking down a smart fridge, you'll find yourself from time to time in the position of needing to launch of bunch of SYN packets at something. This script is tested on Mac and several Linux distros. It needs to be run as root. Clone it from [github](https://github.com/kevin-albert/synflood) or just copy-paste from here. Run it with no arguments (e.g. `$ make && ./synflood`) to get a help message.
